...
$nama = "Agus Alvianto";
$nip = "198408252015021001";
$pangkatgol = "Penata Tk.I / III c";
$jabatan = "Kepala Sub Bagian Umum dan Kepegawaian";
$instansi = "Kecamatan Gandusari";
echo "Nama : $nama <br> NIP : $nip <br> Pangkat/Gol : $pangkatgol <br> 
Jabatan : $jabatan <br> Instansi : $instansi";
?>
</body>
</html>